...
import { Application, ApplicationReviewStatus } from "@/lib/speech/models/speech";
		...
		<Card className="w-full max-w-md lg:max-w-xl p-6 grid gap-6">
			...
			<div className="flex justify-end gap-2">
				<Button
					variant="destructive"
					onClick={onCancel}
					disabled={application.canceled || application.applicationReviewStatus === ApplicationReviewStatus.DENIED}
				>
					取消上菜
				</Button>
			</div>
